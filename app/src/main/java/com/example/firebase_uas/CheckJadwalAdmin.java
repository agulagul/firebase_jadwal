...
public class CheckJadwalAdmin extends AppCompatActivity implements RecyclerViewClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_jadwal_admin);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CheckJadwalAdmin.this));
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new DataAdapter(CheckJadwalAdmin.this, listJadwal, CheckJadwalAdmin.this);
...
//                .putExtra(Intent.EXTRA_EMAIL, "rowan@example.com,trevor@example.com");
    ...
    public void onClick(int position) {
        ...
        Intent intent = new Intent(CheckJadwalAdmin.this, EditJadwalAdmin.class);
